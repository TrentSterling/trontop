...
(async () => {
  ...
  try {
    ...
    await page.setContent(`<!doctype html><html><head><style>
      ...
      </style></head><body><div class="copy"><div class="brand"><img src="${src('logo.png')}" alt="">TRONTOP</div><h1>Your PC.<br><span>In full color.</span></h1><p>A native Windows task manager<br>with a serious color habit.</p></div><div class="shots"><img class="one" src="${src('daylight-overview.png')}" alt=""><img class="two" src="${src('spectrum-overview.png')}" alt=""><img class="three" src="${src('electric-overview.png')}" alt=""></div><div class="url">tront.xyz/trontop</div><div class="demo">Real telemetry from Trent's PC</div></body></html>`);
